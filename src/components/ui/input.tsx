...
const input = tv({
  ...
  variants: {
    variant: {
      default: {},
      filter: {
        root: "rounded-full py-1 px-3 flex items-center gap-1.5 text-xs text-zinc-500 leading-tight border-dashed focus-within:border-zinc-600",
        control:
          "bg-transparent flex-1 outline-none border-0 focus:ring-0 focus:ring-offset-0 text-xs",
      },
    },
  },
  defaultVariants: {
